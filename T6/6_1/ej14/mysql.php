...
//solo hay que almacenar la referencia a los campos que están en el WHERE y en SET
                if ($valor['operador']) {
...
function ejecutarConsulta($consulta, $tabla) {
    ...
    if (!@mysqli_stmt_execute($consulta)) {
        ...
        if ($funcion == 'select') {
            ...
            $mensaje = "<h3>Se han podido $operacion los datos en tabla $tabla satisfactoriamente.</h3>\n";
            return true;
        }
    }
    cerrarConsulta($consulta);
